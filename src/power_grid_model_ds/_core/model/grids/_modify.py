...
def add_node(grid: "Grid", node: NodeArray) -> None:
    ...
    logger.debug("added node %d", node.id)
...
def add_branch(grid: "Grid", branch: BranchArray) -> None:
    ...
    logger.debug("added branch %d from %d to %d", branch.id, branch.from_node, branch.to_node)
...
def make_active(grid: "Grid", branch: BranchArray) -> None:
    ...
    logger.debug("activated branch %d", branch.id)
...
def make_inactive(grid, branch: BranchArray, at_to_side: bool = True) -> None:
    ...
    logger.debug("deactivated branch %d", branch.id)
...
def delete_node(grid: "Grid", node: NodeArray) -> None:
    ...
    grid.rebuild_ids()
    logger.debug("deleted node %d", node.id)
...
def delete_branch(grid: "Grid", branch: BranchArray) -> None:
    ...
    grid.rebuild_ids()
    logger.debug("""deleted branch %d from %d to %d""", branch.id, branch.from_node, branch.to_node)
...
def delete_branch3(grid: "Grid", branch: Branch3Array) -> None:
    ...
    grid.rebuild_ids()
    logger.debug("deleted branch3 %d", branch.id)
...
def delete_appliance(grid: "Grid", appliance: ApplianceArray) -> None:
    ...
    grid.rebuild_ids()
    logger.debug("deleted appliance %d", appliance.id)
