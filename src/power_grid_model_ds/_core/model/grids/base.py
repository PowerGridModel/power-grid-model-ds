...
class Grid(FancyArrayContainer):
    ...
    def merge(self, other_grid: G) -> None:
        ...
        # Now append all arrays from the other grid to this grid
        for array in other_grid.get_all_arrays():
            self.append(array)
        # Todo: above 2 lines are generated by copilot, no clue if this works and is complete
